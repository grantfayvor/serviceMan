                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    <span class="label label-primary">Current location</span>
                                </div>
                            </div>
                            <div id="google-map" style="height:500px;" class="ibox-content">
                                <!-- <div id="google-map" class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="height:500px;"></div> -->
