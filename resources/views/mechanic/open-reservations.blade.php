...
<head>
    ...
    <title>Mechanic services | Open Reservations</title>
...
<body data-ng-controller="ReservationController" class="pace-done" data-ng-init="openReservations()">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg" style="min-height: 422px;"> 
                                            ...
                                            <tbody>
                                                <tr data-ng-repeat="reservation in reservations">
                                                    ...
                                                    <td class="col-sm-2 col-md-2">
                                                        ...
                                                        <a class="btn btn-white btn-sm" href="javascript:void(0)" data-ng-click="acceptModal(reservation.id)"><i class="fa fa-check-circle"></i> Accept Reservation</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
            ...
            <div id="acceptModal" class="modal fade" aria-hidden="false" tabindex="-1" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group"><label>Do you want to accept this reservation?</label></div>
						</div>
						<div class="modal-footer">
							<button type="button" data-ng-click="acceptReservation()" class="btn btn-info">Ok</button>
