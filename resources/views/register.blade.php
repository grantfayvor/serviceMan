...
<div class="middle-box text-center loginscreen   animated fadeInDown">
    <div>
        ...
        <form class="m-t" role="form" method="POST" action="{{ route('user-register') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input class="form-control" name="firstName" value="{{ old('firstName') }}" required=""
            ...
            <div class="form-group">
                <input class="form-control" name="identificationNumber" value="{{ old('identificationNumber') }}"
                       required="" placeholder="Enter your drivers license number" type="text">
            </div>
            <div class="form-group">
                <input class="form-control" type="file" name="photo" required="" placeholder="Select Profile Photo"
                       value="{{ old('photo') }}">
            </div>
            <div class="form-group">
                <input class="form-control" name="password" data-ng-model="new_user.password" placeholder="Password"
                       required="" type="password">
            </div>
            <div class="form-group">
                <label style="color:red!important;" for="passwordConfirm" data-ng-show="!passwordMatch">Password does
                    not match.</label>
                <input id="passwordConfirm" class="form-control" required="" name="passwordConfirm"
                       data-ng-model="new_user.confirmPassword"
            ...
            <div class="form-group">
                <div class="checkbox i-checks"><label class="">
                        ...
                        <i></i> Agree to the terms and policy </label></div>
            </div>
        ...
        <p class="m-t">
            <small>Mechanic services © 2017</small>
        </p>
    </div>
</div>
@endif
