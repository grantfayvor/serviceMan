...
<head>
    ...
    <title>Mechanic services | All Users</title>
...
<body data-ng-controller="UserController" class="pace-done" data-ng-init="getAllUsers()">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr data-ng-repeat="user in users">
                                            ...
                                            <td class="col-sm-2 col-md-2">
                                                ...
                                                <a class="btn btn-white btn-sm" href="javascript:void(0)" data-ng-click="deleteUserModal(user.id)"><i class="fa fa-trash"></i> Delete User</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group"><label>Do you really want to delete this user?</label></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-ng-click="deleteUser()" class="btn btn-info">Ok</button>
