...
<head>
    ...
    <title>Mechanic services | All Mechanics</title>
...
<body data-ng-controller="UserController" class="pace-done" data-ng-init="getAllMechanics()">
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    <!-- <a class="btn btn-primary btn-xs" href="/new-mechanic">New Reservation</a> -->
                                </div>
                            </div>
                            <div class="ibox-content">
                                ...
                                <div class="table table-responsive">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <tr data-ng-repeat="mechanic in mechanics">
                                            <td class="col-sm-1 col-md-1">
                                                <b><span class="label red" data-ng-bind="$index + 1"></span></b>
                                            </td>
                                            <td class="col-sm-2 col-md-2">
                                                <span data-ng-bind="mechanic.user.first_name"></span>
                                            </td>
                                            <td class="col-sm-2 col-md-2">
                                                <span data-ng-bind="mechanic.user.last_name"></span>
                                            </td>
                                            <td class="col-sm-2 col-md-2">
                                                <!-- <small>Created by Peter Williams</small> -->
                                                <span class="" data-ng-bind="mechanic.user.username"></span>
                                            </td>
                                            <td class="col-sm-3 col-md-3">
                                                <span data-ng-bind="mechanic.user.email"></span>
                                            </td>
                                            <td class="col-sm-2 col-md-2">
                                                <!-- <a class="btn btn-white btn-sm" href="view.html"><i class="fa fa-folder"></i> View File</a> -->
                                                <a class="btn btn-white btn-sm" href="javascript:void(0)" data-ng-click="deleteMechanicModal(mechanic.user.id)"><i class="fa fa-trash"></i> Delete Mechanic</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                        <h4 class="modal-title">Delete Mechanic</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group"><label>Do you really want to delete this mechanic?</label></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-ng-click="deleteMechanic()" class="btn btn-info">Ok</button>
